...
function renderOverview(data) {
    ...
    document.getElementById('metric-storage').textContent = formatBytes(data.totals.bucketAttachmentBytes);

    const orphanInfo = document.getElementById('orphan-info');
    if (data.totals.orphanedAttachmentCount) {
    ...
    notesTable.innerHTML = data.notes.map((note) => `
        <tr>
            ...
            <td>
                <button type="button" data-action="attachments" data-slug="${encodeURIComponent(note.slug)}">Limpar anexos</button>
